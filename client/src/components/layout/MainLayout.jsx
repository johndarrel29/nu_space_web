...
function MainLayout({ children }) {
  ...
  // Computed values
  const excludedPaths = ["/accreditation", `/accreditation/${documentId}`];
  ...
  const shouldShowOverlay = isUserStatusActive && !excludedPaths.includes(currentPath) && !currentPath.startsWith('/accreditation/');
